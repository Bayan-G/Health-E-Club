...
import 'package:health_e_club/Widgets/isSelectionMode.dart';
...
typedef EventListBuilder(BuildContext context, List<Calendar_Booking> events);
...
class Calendar extends StatefulWidget {
  ...
  final ValueChanged<Calendar_Booking>? onEventSelected;
...
class _CalendarState extends State<Calendar> {
  ...
  List<Calendar_Booking>? _selectedEvents;
          ...
          child: Row(
            ...
            children: <Widget>[
              Text(
                ...
                style: widget.bottomBarTextStyle ?? TextStyle(fontSize: 15),
              ),
              IconButton(
        ...
        child: _selectedEvents != null && _selectedEvents!.isNotEmpty
            ? ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final Calendar_Booking event = _selectedEvents![index];
                  final String start = DateFormat("h:mma").format(event.createdDate);
                  return Container(
                    height: 60.0,
                    child: Row(
                        ...
                        Expanded(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                USER_NAME(item: event.Doctor_NAME),
                        ...
                        SizedBox(
                          ...
                          child: Card(
                            ...
                            child: Select(
                              ...
                              styleColor: const Color(0xffD9D9D9),
                              id: event.uid,
                              onSelected: (id) {
